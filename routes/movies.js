...
router.get('/' , async (req, res) => {
    ...
    if(!movies || movies.length <= 0) return res.send('There are no movies in the database');
    res.send(movies);
});
...
router.put('/:id' , [auth , validation(movieValidation) , admin , validateObjectId], async (req, res) => {
